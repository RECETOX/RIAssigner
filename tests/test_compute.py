...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            SimpleData([], "seconds", [100]),
            SimpleData([10], "seconds", [100]),
            "Query data has no retention times.",
        ],
        [
            SimpleData([10], "seconds", [100]),
            SimpleData([10], "seconds", []),
            "Reference data has no retention indices.",
        ],
        [
            SimpleData([10], "seconds", [100]),
            SimpleData([], "seconds", [10]),
            "Reference data has no retention times.",
        ],
    ],
)
